# sentinel-gcp - Terraform Outputs
...
output "logs_url" {
  ...
  value       = "https://console.cloud.google.com/logs/query;query=resource.type%3D%22cloud_run_revision%22%20resource.labels.service_name%3D%22sentinel-gcp%22?project=${var.project_id}"
}
...
output "cloud_run_console_url" {
  ...
  value       = "https://console.cloud.google.com/run/detail/${var.region}/sentinel-gcp?project=${var.project_id}"
}
...
output "logs_command" {
  ...
  value       = "gcloud run logs tail sentinel-gcp --region ${var.region} --project ${var.project_id}"
}