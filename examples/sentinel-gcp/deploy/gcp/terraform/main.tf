# sentinel-gcp - Production-Grade Terraform Configuration for GCP
...
resource "google_service_account" "agent" {
  ...
  display_name = "sentinel-gcp Agent Service Account"
  description  = "Service account for sentinel-gcp ADK agent on Cloud Run"
  project      = var.project_id
}
...
resource "google_artifact_registry_repository" "agent_repo" {
  ...
  description   = "Docker repository for sentinel-gcp ADK agent"
  format        = "DOCKER"
  project       = var.project_id
...
resource "google_logging_metric" "agent_invocations" {
  ...
  description = "Count of agent invocations for sentinel-gcp"
  project     = var.project_id
...
resource "google_logging_metric" "agent_errors" {
  ...
  description = "Count of errors for sentinel-gcp"
  project     = var.project_id
