# investment-advisor - Terraform Outputs
...
output "container_image" {
  ...
  value       = "${var.region}-docker.pkg.dev/${var.project_id}/${google_artifact_registry_repository.agent_repo.repository_id}/investment-advisor:${var.image_tag}"
}
...
output "logs_url" {
  ...
  value       = "https://console.cloud.google.com/logs/query;query=resource.type%3D%22cloud_run_revision%22%20resource.labels.service_name%3D%22investment-advisor%22?project=${var.project_id}"
}
...
output "cloud_run_console_url" {
  ...
  value       = "https://console.cloud.google.com/run/detail/${var.region}/investment-advisor?project=${var.project_id}"
}
...
output "logs_command" {
  ...
  value       = "gcloud run logs tail investment-advisor --region ${var.region} --project ${var.project_id}"
}