...
- **Cloud Run Dashboard**: [console.cloud.google.com/run](https://console.cloud.google.com/run?project=your-gcp-project-id)
- **Logs Explorer**: [console.cloud.google.com/logs](https://console.cloud.google.com/logs?project=your-gcp-project-id)
- **Error Reporting**: [console.cloud.google.com/errors](https://console.cloud.google.com/errors?project=your-gcp-project-id)
...
gcloud projects add-iam-policy-binding your-gcp-project-id \
  --member="serviceAccount:investment_advisor-sa@your-gcp-project-id.iam.gserviceaccount.com" \
  --role="roles/aiplatform.user"
```
...
gcloud artifacts docker images delete \
  europe-west1-docker.pkg.dev/your-gcp-project-id/investment_advisor-repo/investment_advisor \
  --delete-tags \
  --quiet
...
gcloud iam service-accounts delete investment_advisor-sa@your-gcp-project-id.iam.gserviceaccount.com \
  --quiet
```
